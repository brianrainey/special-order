 ...
 */
carddb.initialize.then(beginListening);

/**
 * Define the Special Order toolbar button.
 */
...
/**
 * Define the Panel that will pop-up to show selected cards.
 */
var panel = Panel({
  width: 300,
  height: 418,
...
/**
 * Define a Keyboard Shortcut to display then panel.
 */
...
/**
 * After initiaization, begin listening for text selections from the
 * user.
 */
